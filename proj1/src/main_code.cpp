...
int main(){
	...
	std::string strJacobi ("Jacobi"), strGauss("Gauss-Seidel");	
	if( solver_type.compare(strJacobi) != 0 && solver_type.compare(strGauss) != 0 ) std::cerr << "Invalid solver: It should be either Gauss-Seidel or Jacobi" << std::endl;
