...
# PETSc
#1 Dimension
Petsc_dim1_order2 = np.loadtxt("output_Petsc_dim1_order2.dat",skiprows=1)


Petsc_dim1_order2_fit, cov = curve_fit(f=power_law, xdata=Petsc_dim1_order2[0:5,0], ydata=Petsc_dim1_order2[0:5,1], bounds=(-np.inf, np.inf))
Petsc_dim1_order2_x = np.logspace(np.log10(Petsc_dim1_order2[0,0]), np.log10(Petsc_dim1_order2[4,0]),10000)

#ABSOLUTE ERRORS===========================================================
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Petsc_dim1_order2[:,0],Petsc_dim1_order2[:,1],'ro',label=r'Petsc $2^{nd}$')

plot = plt.loglog(Petsc_dim1_order2_x,power_law(Petsc_dim1_order2_x, *Petsc_dim1_order2_fit),'r--',label=r'Fit: $O( N^{%5.4f})$' %Petsc_dim1_order2_fit[1] )
...
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'convergence_study_Petsc_1D.png',bbox_inches='tight', dpi = 600)

#2 Dimension
Petsc_dim2_order2 = np.loadtxt("output_Petsc_dim2_order2.dat",skiprows=1)


Petsc_dim2_order2_fit, cov = curve_fit(f=power_law, xdata=Petsc_dim2_order2[0:5,0], ydata=Petsc_dim2_order2[0:5,1], bounds=(-np.inf, np.inf))
Petsc_dim2_order2_x = np.logspace(np.log10(Petsc_dim2_order2[0,0]), np.log10(Petsc_dim2_order2[4,0]),10000)

#ABSOLUTE ERRORS===========================================================
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Petsc_dim2_order2[:,0],Petsc_dim2_order2[:,1],'ro',label=r'Petsc $2^{nd}$')

plot = plt.loglog(Petsc_dim2_order2_x,power_law(Petsc_dim2_order2_x, *Petsc_dim2_order2_fit),'r--',label=r'Fit: $O( N^{%5.4f})$' %Petsc_dim2_order2_fit[1] )
...
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'convergence_study_Petsc_2D.png',bbox_inches='tight', dpi = 600)
...
#1 Dimension
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Petsc_dim1_order2[:,0],Petsc_dim1_order2[:,2],'ro--',label=r'Petsc $2^{nd}$')
manager = plt.get_current_fig_manager()
manager.window.showMaximized()
plt.ylabel(r'Runtime [s]')
plt.xlabel(r'$N$')
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'runtime_Petsc_1D.png',bbox_inches='tight', dpi = 600)

#2 Dimension
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Petsc_dim2_order2[:,0],Petsc_dim2_order2[:,2],'ro--',label=r'Petsc $2^{nd}$')
...
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'runtime_Petsc_2D.png',bbox_inches='tight', dpi = 600)
...
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Jacobi_dim1_order2[:,0],Jacobi_dim1_order2[:,2],'ro--',label=r'Jacobi $2^{nd}$')
plot = plt.loglog(Gauss_dim1_order2[:,0],Gauss_dim1_order2[:,2],'bX--',label=r'Gauss-Seidel $2^{nd}$')
plot = plt.loglog(Petsc_dim1_order2[:,0],Petsc_dim1_order2[:,2],'ks--',label=r'Petsc $2^{nd}$')
...
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'order2_runtime_comparative_1D.png',bbox_inches='tight', dpi = 600)

#2 Dimensions
ax = plt.figure(figsize=(15,7.5) , dpi=100)
plot = plt.loglog(Gauss_dim2_order2[:,0],Gauss_dim2_order2[:,2],'ro--',label=r'Gauss-Seidel $2^{nd}$')
plot = plt.loglog(Jacobi_dim2_order2[:,0],Jacobi_dim2_order2[:,2],'bX--',label=r'Jacobi $2^{nd}$')
plot = plt.loglog(Petsc_dim2_order2[:,0],Petsc_dim2_order2[:,2],'ks--',label=r'Petsc $2^{nd}$')
manager = plt.get_current_fig_manager()
manager.window.showMaximized()
plt.ylabel(r'Runtime [s]')
plt.xlabel(r'$N$')
legend = plt.legend(loc='best', shadow=False, fontsize='x-large')
plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
plt.savefig(f'order2_runtime_comparative_2D.png',bbox_inches='tight', dpi = 600)
...
#2 Dimension
#Second order
Jacobi_dim2_order2_plot = np.loadtxt("ref_sol_Jacobi-Seidel_dim2_order2_n75.dat",skiprows=1)
