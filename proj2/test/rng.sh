...
@test "verifying that the 1D, 2nd order Gauss-Seidel solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Gauss-Seidel_dim1_order2_n25.dat
	[ "$status" -eq 0 ]

}


@test "verifying that the 1D, 4th order Gauss-Seidel solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Gauss-Seidel_dim1_order4_n25.dat
	[ "$status" -eq 0 ]
}

@test "verifying that the 2D, 2nd order Gauss-Seidel solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Gauss-Seidel_dim2_order2_n10.dat
	[ "$status" -eq 0 ]
}

@test "verifying that the 2D, 4th order Gauss-Seidel solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Gauss-Seidel_dim2_order4_n10.dat
	[ "$status" -eq 0 ]
}

@test "verifying that the 1D, 2nd order Jacobi solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Jacobi_dim1_order2_n25.dat
	[ "$status" -eq 0 ]

}

@test "verifying that the 2D, 2nd order Jacobi solver matches with reference outputs" {
	...
	run diff sol.dat ./results/ref_sol_Jacobi_dim2_order2_n10.dat
	[ "$status" -eq 0 ]
